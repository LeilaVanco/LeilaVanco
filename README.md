...
- I am creating a Discord Bot in Python (maybe use MongoDB Compass as db as I did in the past*, and the bot probably be hosted on a raspberry pi)
...
# One last thing.... TAKE THIS CATTT
